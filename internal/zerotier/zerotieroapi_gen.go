...
//
// Code generated by github.com/vbargl/zerotier-ctl version (devel) DO NOT EDIT.
package zerotier
...
const (
	ControllerNetworkObjtypeNetwork ControllerNetworkObjtype = "network"
)

// Defines values for ControllerNetworkMemberObjtype.
const (
	ControllerNetworkMemberObjtypeMember ControllerNetworkMemberObjtype = "member"
)
...
const (
	NetworkDNSDomain1Empty NetworkDNSDomain1 = ""
)
...
const (
	PeerRoleLEAF   PeerRole = "LEAF"
	PeerRoleMOON   PeerRole = "MOON"
	PeerRolePLANET PeerRole = "PLANET"
)
...
type ControllerNetwork struct {
	...
	IpAssignmentPools []ControllerNetwork_IpAssignmentPools `json:"ipAssignmentPools"`
	Mtu               MTU                                   `json:"mtu"`
	...
	Routes            []ControllerNetwork_Routes            `json:"routes"`
	Rules             []NetworkRule                         `json:"rules"`
	Tags              NetworkTagsItem                       `json:"tags"`
	V4AssignMode      ControllerNetwork_V4AssignMode        `json:"v4AssignMode"`
	V6AssignMode      ControllerNetwork_V6AssignMode        `json:"v6AssignMode"`
}
...
// ControllerNetwork_IpAssignmentPools defines model for ControllerNetwork.IpAssignmentPools.
type ControllerNetwork_IpAssignmentPools struct {
...
// ControllerNetwork_Routes defines model for ControllerNetwork.Routes.
type ControllerNetwork_Routes struct {
	Target ControllerNetwork_Routes_Target                 `json:"target"`
	Via    nullable.Nullable[ControllerNetwork_Routes_Via] `json:"via,omitempty"`
}

// ControllerNetwork_V4AssignMode defines model for ControllerNetwork.V4AssignMode.
type ControllerNetwork_V4AssignMode struct {
	Zt *bool `json:"zt,omitempty"`
}

// ControllerNetwork_V6AssignMode defines model for ControllerNetwork.V6AssignMode.
type ControllerNetwork_V6AssignMode struct {
...
type ControllerNetworkMember struct {
	...
	IpAssignments                *[]ControllerNetworkMember_IpAssignments `json:"ipAssignments,omitempty"`
	LastAuthorizedCredential     nullable.Nullable[string]                `json:"lastAuthorizedCredential"`
	...
	RemoteTraceTarget            nullable.Nullable[string]                `json:"remoteTraceTarget"`
...
// ControllerNetworkMember_IpAssignments defines model for ControllerNetworkMember.IpAssignments.
type ControllerNetworkMember_IpAssignments struct {
	union json.RawMessage
}
...
type ControllerNetworkMemberListFull struct {
	...
	Meta ControllerNetworkMemberListFull_Meta `json:"meta"`
}

// ControllerNetworkMemberListFull_Meta defines model for ControllerNetworkMemberListFull.Meta.
type ControllerNetworkMemberListFull_Meta struct {
...
type ControllerNetworkMemberRequest struct {
	ActiveBridge    *bool                                           `json:"activeBridge,omitempty"`
	Authorized      *bool                                           `json:"authorized,omitempty"`
	IpAssignments   *[]ControllerNetworkMemberRequest_IpAssignments `json:"ipAssignments,omitempty"`
	Name            *string                                         `json:"name,omitempty"`
	NoAutoAssignIps *bool                                           `json:"noAutoAssignIps,omitempty"`
	SsoExempt       *bool                                           `json:"ssoExempt,omitempty"`
}

// ControllerNetworkMemberRequest_IpAssignments defines model for ControllerNetworkMemberRequest.IpAssignments.
type ControllerNetworkMemberRequest_IpAssignments struct {
	union json.RawMessage
}
...
type ControllerNetworkRequest struct {
	...
	IpAssignmentPools *[]ControllerNetworkRequest_IpAssignmentPools `json:"ipAssignmentPools,omitempty"`
	Mtu               *MTU                                          `json:"mtu,omitempty"`
	MulticastLimit    *USafeint                                     `json:"multicastLimit,omitempty"`
	Name              *string                                       `json:"name,omitempty"`
	Private           *bool                                         `json:"private,omitempty"`
	Routes            *[]ControllerNetworkRequest_Routes            `json:"routes,omitempty"`
	V4AssignMode      *ControllerNetworkRequest_V4AssignMode        `json:"v4AssignMode,omitempty"`
	V6AssignMode      *ControllerNetworkRequest_V6AssignMode        `json:"v6AssignMode,omitempty"`
}
...
// ControllerNetworkRequest_IpAssignmentPools defines model for ControllerNetworkRequest.IpAssignmentPools.
type ControllerNetworkRequest_IpAssignmentPools struct {
...
// ControllerNetworkRequest_Routes defines model for ControllerNetworkRequest.Routes.
type ControllerNetworkRequest_Routes struct {
	Target ControllerNetworkRequest_Routes_Target                 `json:"target"`
	Via    nullable.Nullable[ControllerNetworkRequest_Routes_Via] `json:"via,omitempty"`
}

// ControllerNetworkRequest_V4AssignMode defines model for ControllerNetworkRequest.V4AssignMode.
type ControllerNetworkRequest_V4AssignMode struct {
	Zt *bool `json:"zt,omitempty"`
}

// ControllerNetworkRequest_V6AssignMode defines model for ControllerNetworkRequest.V6AssignMode.
type ControllerNetworkRequest_V6AssignMode struct {
	N6plane *bool `json:"6plane,omitempty"`
	Rfc4193 *bool `json:"rfc4193,omitempty"`
	Zt      *bool `json:"zt,omitempty"`
}
...
type ControllerNetworks struct {
	...
	Meta ControllerNetworks_Meta `json:"meta"`
}

// ControllerNetworks_Meta defines model for ControllerNetworks.Meta.
type ControllerNetworks_Meta struct {
...
type NetworkDNS struct {
	...
	Servers []NetworkDNS_Servers `json:"servers"`
}
...
// NetworkDNS_Servers defines model for NetworkDNS.Servers.
type NetworkDNS_Servers struct {
	union json.RawMessage
}
...
type NodeStatus struct {
	Address              ZTAddress               `json:"address"`
	Clock                USafeint                `json:"clock"`
	Config               NodeStatus_Config       `json:"config"`
...
// NodeStatus_Config_Settings defines model for NodeStatus.Config.Settings.
type NodeStatus_Config_Settings struct {
...
// NodeStatus_Config defines model for NodeStatus.Config.
type NodeStatus_Config struct {
	Settings NodeStatus_Config_Settings `json:"settings"`
}
...
// Peer_Paths defines model for Peer.Paths.
type Peer_Paths struct {
...
// AsIPv4 returns the union data inside the ControllerNetworkMember_IpAssignments as a IPv4
func (t ControllerNetworkMember_IpAssignments) AsIPv4() (IPv4, error) {
	var body IPv4
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromIPv4 overwrites any union data inside the ControllerNetworkMember_IpAssignments as the provided IPv4
func (t *ControllerNetworkMember_IpAssignments) FromIPv4(v IPv4) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeIPv4 performs a merge with any union data inside the ControllerNetworkMember_IpAssignments, using the provided IPv4
func (t *ControllerNetworkMember_IpAssignments) MergeIPv4(v IPv4) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsIPv6 returns the union data inside the ControllerNetworkMember_IpAssignments as a IPv6
func (t ControllerNetworkMember_IpAssignments) AsIPv6() (IPv6, error) {
	var body IPv6
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromIPv6 overwrites any union data inside the ControllerNetworkMember_IpAssignments as the provided IPv6
func (t *ControllerNetworkMember_IpAssignments) FromIPv6(v IPv6) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeIPv6 performs a merge with any union data inside the ControllerNetworkMember_IpAssignments, using the provided IPv6
func (t *ControllerNetworkMember_IpAssignments) MergeIPv6(v IPv6) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t ControllerNetworkMember_IpAssignments) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *ControllerNetworkMember_IpAssignments) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}
...
// AsIPv4 returns the union data inside the ControllerNetworkMemberRequest_IpAssignments as a IPv4
func (t ControllerNetworkMemberRequest_IpAssignments) AsIPv4() (IPv4, error) {
	var body IPv4
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromIPv4 overwrites any union data inside the ControllerNetworkMemberRequest_IpAssignments as the provided IPv4
func (t *ControllerNetworkMemberRequest_IpAssignments) FromIPv4(v IPv4) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeIPv4 performs a merge with any union data inside the ControllerNetworkMemberRequest_IpAssignments, using the provided IPv4
func (t *ControllerNetworkMemberRequest_IpAssignments) MergeIPv4(v IPv4) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsIPv6 returns the union data inside the ControllerNetworkMemberRequest_IpAssignments as a IPv6
func (t ControllerNetworkMemberRequest_IpAssignments) AsIPv6() (IPv6, error) {
	var body IPv6
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromIPv6 overwrites any union data inside the ControllerNetworkMemberRequest_IpAssignments as the provided IPv6
func (t *ControllerNetworkMemberRequest_IpAssignments) FromIPv6(v IPv6) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeIPv6 performs a merge with any union data inside the ControllerNetworkMemberRequest_IpAssignments, using the provided IPv6
func (t *ControllerNetworkMemberRequest_IpAssignments) MergeIPv6(v IPv6) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t ControllerNetworkMemberRequest_IpAssignments) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *ControllerNetworkMemberRequest_IpAssignments) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}
...
// AsIPv4 returns the union data inside the NetworkDNS_Servers as a IPv4
func (t NetworkDNS_Servers) AsIPv4() (IPv4, error) {
	var body IPv4
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromIPv4 overwrites any union data inside the NetworkDNS_Servers as the provided IPv4
func (t *NetworkDNS_Servers) FromIPv4(v IPv4) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeIPv4 performs a merge with any union data inside the NetworkDNS_Servers, using the provided IPv4
func (t *NetworkDNS_Servers) MergeIPv4(v IPv4) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsIPv6 returns the union data inside the NetworkDNS_Servers as a IPv6
func (t NetworkDNS_Servers) AsIPv6() (IPv6, error) {
	var body IPv6
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromIPv6 overwrites any union data inside the NetworkDNS_Servers as the provided IPv6
func (t *NetworkDNS_Servers) FromIPv6(v IPv6) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeIPv6 performs a merge with any union data inside the NetworkDNS_Servers, using the provided IPv6
func (t *NetworkDNS_Servers) MergeIPv6(v IPv6) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t NetworkDNS_Servers) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *NetworkDNS_Servers) UnmarshalJSON(b []byte) error {
	err := t.union.UnmarshalJSON(b)
	return err
}
...
var swaggerSpec = []string{
	...
	"H4sIAAAAAAAC/+xc63PayJb/V7q09yM2tpNy3VC1H4hNMuzYwAK+d2til6uRDtCJ1K1ptXCYlPdv3+qH",
	"3i2QHNuZZPlkg/pxHr/z6HNafHNcFoSMAhWR0/vmRO4aAqz+vWBUcOb7wEcgHhj/Ir8MOQuBCwJqiItD",
	"vCA+ST7/g8PS6Tn/0c0W7ZoVu2aRCxxGQwGB89hxXA5YEEbnJIB90+MZXgKhQs7zqNoN0+146fQ+Ndr3",
	"cjRzHju7hw6CUGz7nOOtpvDuseMAxQsf3nOGPRdHQu4rtiE4PWfBmA+YSoKIt4/8P+aGjuGlmhD2o4is",
	"aABUTBjzFT9EQBBVhUzCKaYrGFCvOdPDyebtXnaHk825ZtJsMROYixfa5LHjcPgzJhw8p/epuGMnz+Nd",
